...
/**
 * Storage location controller - Spring MVC version
 */
@Controller
@RequestMapping("/admin/biz/stock/storage-location")
@MetaData("库存地管理")
public class StorageLocationMvcController extends BaseMvcController<StorageLocation, String> {
    ...
    @ResponseBody
    public Page<StorageLocation> findByPage() {
    ...
    @ResponseBody
    public List<StorageLocation> selectOptions() {
